...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link <%=request.getParameter("page").equals("canciones")? "active": "" %>" href="<%=request.getContextPath()%>/listaCancionesPorBanda">Canciones</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link <%=request.getParameter("page").equals("playlists")? "active": "" %>" href="<%=request.getContextPath()%>/playlists">Playlists</a>
            </li>
